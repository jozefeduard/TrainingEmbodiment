...
public class DistanceToAvatar : MonoBehaviour
{
    public Leaderboard leaderboard;
    public float speed = 10.0f;
    public float rotationSpeed = 100.0f;
    public GameObject placeholder;
    public TextMeshProUGUI AvatarDistance;
    float ADistance;
    int score;
    ...
    void CalculateDistance()
    {
        if(placeholder)
        {
            ...
            float ADistance = 100 * (distance - 1);       
            int scoreToUpload = Mathf.RoundToInt(ADistance);
